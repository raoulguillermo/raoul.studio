// Kontaktseiten-Inhalt (Deutsch).

export const contact = {
  meta: {
    title: 'Kontakt — raoul.studio',
    description:
  ...
  titleLine2: 'wir',
  titleAccent: '.',
  lead: 'Erzählen Sie uns, was Sie bauen oder was Sie ausbremst.',
  form: {
    nameLabel: 'Name',
    ...
    companyPlaceholder: 'Firmen- oder Projektname',
    messageLabel: 'Nachricht',
    messagePlaceholder:
      'Was bauen Sie? Was ist das Problem, für wen ist es, und wo stehen Sie gerade — Idee, halbfertig oder live und festgefahren? Je konkreter, desto besser.',
    sendLabel: 'nachricht senden',
  },
  directContact: {
    label: 'Oder schreiben Sie uns direkt',
    email: 'hello@raoul.studio',
    phoneLabel: 'Oder anrufen',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Maßgeschneiderte Produkte und Plattformen für Fintech, Kanzleien, kommerzielle Agenturen und E-Commerce — Webplattformen und SaaS, headless E-Commerce, KI-Tools und Automatisierung, CRMs und interne Tools, APIs und zweiseitige Marktplätze.',
      },
      {
        q: 'Wie erreiche ich Sie direkt?',
        a: 'Per E-Mail an hello@raoul.studio oder über das Formular auf dieser Seite. Beides landet direkt bei uns — keine Zwischeninstanz.',
      },
    ],
  },
  posterRailMiddle: 'Reden wir · Kontakt aufnehmen',
}
