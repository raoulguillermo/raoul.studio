...
export const contact = {
  ...
  titleLine2: '',
  titleAccent: '.',
  lead: 'Cuéntanos qué estás construyendo o qué te está frenando.',
  form: {
    nameLabel: 'Nombre',
    ...
    messagePlaceholder:
      '¿Qué estás construyendo? ¿Cuál es el problema, para quién es y en qué punto estás: idea, a medio hacer, o en producción y atascado? Cuanto más concreto, mejor.',
  ...
  posterRailMiddle: 'Hablemos · Ponte en contacto',
}
