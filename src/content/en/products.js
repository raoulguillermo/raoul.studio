...
export const products = {
  'voice-ai': {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: 'What does it cost?',
          a: 'From €149 a month, including around 300 calls, plus a one-off setup fee of €495 (excl. VAT). More calls, or connections to your own systems? Then you get a fixed price after the demo.',
        },
      ],
    },
    getStarted: {
    ...
    pricing: {
      ...
      unit: 'a month',
      points: [
        'Includes around 300 calls a month',
        'One-off setup: €495',
        'Connections to your own systems by arrangement',
      ],
      note: 'All prices excl. VAT.',
    },
    callDemo: {
      label: 'Call and hear it yourself',
      note: 'Our AI answers. Go ahead and try to book an appointment.',
      secondary: 'Or book a demo',
    },
    dataPrivacy: {
      label: 'GDPR & data',
      heading: 'What happens to calls.',
      items: [
        { title: 'Only what’s needed', body: 'The assistant only asks for what it needs to get the job done, such as a name, a phone number and the appointment. That goes into your own system.' },
        { title: 'Recordings and transcripts', body: 'Whether calls are recorded and how long transcripts are kept, we agree together. As short as your business needs.' },
        { title: 'Data processing agreement', body: 'We always sign a data processing agreement with you: who processes which data, where and for how long.' },
        { title: 'Who else is involved', body: 'Telephony runs through Twilio, speech through ElevenLabs, and the language model is Claude by Anthropic. The full list is in the data processing agreement.' },
      ],
    },
  ...
  'no-cms': {
    ...
    pricing: {
      ...
      unit: 'a month',
      points: [
        'Plus credit for your changes: you buy tokens and only pay for what you use',
        'Top up your credit whenever you need to',
      ],
      note: 'All prices excl. VAT.',
    },
  ...
  crm: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: 'What does it cost?',
          a: 'A custom CRM starts at €4,950, one-off (excl. VAT). What it ends up costing depends on what it has to do: how many people use it, what it has to keep track of and what it has to connect to. After an introductory call you get a fixed price up front.',
        },
      ],
    },
    getStarted: {
    ...
    pricing: {
      ...
      points: [
        ...
        'A fixed price up front, after an introductory call',
        'Hosting and maintenance by arrangement',
      ],
      note: 'All prices excl. VAT.',
    },
